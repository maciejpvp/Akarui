...
import electron, { app as app$1, ipcMain as ipcMain$1, BrowserWindow, Menu } from "electron";
...
ipcMain$1.handle("set-brightness", (_event, value) => {
  return setBrightness(value);
});
ipcMain$1.handle("set-contrast", (_event, value) => {
